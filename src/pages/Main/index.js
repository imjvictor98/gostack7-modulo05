...
export default class Main extends Component {
  ...
  componentDidMount() {
    ...
    if (repositories) {
      this.setState({ repositories: JSON.parse(repositories) }); // converte o json para array
    }
  }
  ...
  componentDidUpdate(_, prevState) {
    ...
    if (prevState.repositories !== repositories) {
      localStorage.setItem('repositories', JSON.stringify(repositories)); // converte array pra json
    }
  }
